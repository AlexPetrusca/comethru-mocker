...
import { Modal, Text, TextInput, TouchableOpacity, View, FlatList, Alert, Platform } from 'react-native';
...
export function StorageModal({ visible, onRequestClose }: StorageModalProps) {
  ...
  return (
    ...
    >
      <View className="flex-1 bg-black/50 justify-end">
        <View className="bg-white dark:bg-gray-800 rounded-t-2xl max-h-[80%]">
